...
[^1]: Note that I included a [.png](/Entity_Relationship_Diagram/Pewlett_Hackard.png) of the diagram, as the [.pgerd](/Entity_Relationship_Diagram/Pewlett_Hackard.pgerd) file did not create a visual for easy viewing (both files are located in the [Entity_Relationship_Diagram](https://github.com/marthagriggs9/sql_challenge/tree/main/EmployeeSQL/Entity_Relationship_Diagram) folder).
